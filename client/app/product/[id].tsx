    ...
    if (!product) {
        return (
            <SafeAreaView className="flex-1 justify-center items-center px-6">
                ...
                <Text className="mt-1 text-sm text-secondary text-center">
        ...
        <View className=" relative flex-1 bg-white">
            <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
                ...
                <View className="relative h-[450px] bg-gray-100 mb-6">
                    <ScrollView horizontal pagingEnabled
                        ...
                        scrollEventThrottle={16} onScroll={(e)=>{const slide = Math.round(e.nativeEvent.contentOffset.x/e.nativeEvent.layoutMeasurement.width)
            ...
            <View className="absolute bottom-0 left-0 right-0 flex-row p-4 bg-white border-t border-gray-100">
                ...
                <TouchableOpacity onPress={()=>router.push('/(tabs)/cart')} className="w-1/5 py-3 flex-row justify-center relative">
                    ...
                    {itemCount > 0 && (
                        <View className="absolute top-2 right-4 w-4 h-4 z-10 bg-black rounded-full justify-center items-center">
