    ...
    return (
        <SafeAreaView className="flex-1 bg-surface">
            ...
            <View className="flex-row gap-2 mb-3 mx-4 my-2 items-center">
                {/* Search Bar */}
                <View className="flex-row flex-1 items-center gap-2 bg-white rounded-xl px-4 py-1">
                    <Ionicons
                        name="search"
                        size={18}
            ...
            {loading ? (
                ...
                <FlatList
                    ...
                    ListFooterComponent={
                    loadingMore ? (<View className="py-4"><ActivityIndicator size="small" color={COLORS.primary} /></View>
                    ) : null}
                    ListEmptyComponent={
                        !loading ? (
